...
kubectl create -f k8s/org1/enroll-peers-org1.yaml
kubectl create -f k8s/org2/enroll-peers-org2.yaml
kubectl wait --for=condition=complete job -l app=enroll-peers --timeout=${CONTAINER_TIMEOUT} -n hlf
